...
const agencies = [
  {
    ...
    meta: [
      { label: "Best For", val: "Small or startup firms ($2,500 to $4,000/month)" },
      { label: "Starting Price", val: "Starting at $2,500/month" },
    ...
    pros: ["Only major legal SEO agency with publicly listed pricing, no sales games", "No upfront setup fee: costs spread across the 24-month engagement", "100% legal focus means benchmarking against real legal competitors", "Full marketing foundation live in 45 days (brand design, StoryBrand website, GBP, Yelp, Apple Maps, tracking)"],
    cons: ["Not the right fit for firms with $20,000+/month enterprise budgets (use [Juris Digital](https://jurisdigital.com/services/ascend/) instead)", "Newer brand name: long experience behind it, but less legacy name recognition", "Less name recognition than legacy agencies for committee-based vendor approval"],
  ...
  },
  {
    ...
    meta: [
      { label: "Best For", val: "Established and growth-stage firms ($20,000+/month)" },
      { label: "Starting Price", val: "Custom pricing (starting at $20,000+/month)" },
