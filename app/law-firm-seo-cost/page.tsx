...
const faqs = [
  ...
  { question: "Is there a setup fee for law firm SEO?", answer: "Many agencies charge a one-time setup fee (often thousands) that covers the initial audit, keyword research, and onboarding. At JurisPage, our JurisPage plan charges no upfront setup fee. Costs are spread across a 24-month engagement so small and startup firms can afford the work without a large day-one check. JurisPage starts at $2,000/month for small or startup firms with little to no online presence. For established firms, [Juris Digital](https://jurisdigital.com/services/ascend/) provides full-service engagements running $5,000 to $50,000+/month with no upfront setup fees." },
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3 mb-4">
            <div className="flex gap-4 items-center bg-gray-50 border border-gray-200 rounded-xl p-4">
              <div className="flex-shrink-0 w-24 font-heading font-bold text-gray-900 text-sm">JurisPage</div>
