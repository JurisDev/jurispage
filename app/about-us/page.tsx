...
const differences = [
  {
    ...
    body: "We don't play games with pricing. We'll give you a straight answer on cost during your first conversation. No runaround, no mystery packages. Starting at $2,500/month.",
  },
  {
  ...
  },
  {
    ...
    body: "We don't demand a huge day-one check before your marketing has a chance to work. We front-load the work (website, brand design, GBP, citations, social, tracking all live in 45 days) but spread the cost across the 24-month JurisPage engagement.",
  },
  {
            ...
            <table className="w-full border-collapse text-sm shadow-sm">
              ...
              <tbody className="bg-white">
                {[
                  ...
                  ["Starting price", "$2,500/mo (JurisPage)", "$20,000+/mo", "Low cost, high risk"],
