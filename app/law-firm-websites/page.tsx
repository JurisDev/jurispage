...
export default function LawFirmWebsitesPage() {
  const allFaqs = [
    { question: "How much does a custom law firm website cost?", preview: "JurisPage starts at $2,500/mo with no upfront fee. Includes brand design, StoryBrand website, content, SEO, and GBP setup.", answer: "JurisPage starts at $2,500 per month over a 24-month engagement with no upfront setup fee. It includes brand design, a custom StoryBrand-driven WordPress website, practice area content, Google Business Profile setup, Yelp, Apple Maps, and ongoing SEO. Established firms that need a fully bespoke design and content strategy can scope a custom engagement up to $20,000/month. All JurisPage pricing is published on our website. No discovery calls required." },
    { question: "How long does it take to design and launch a law firm website?", preview: "45 days for the full JurisPage foundation. 45-60 days for custom redesigns.", answer: "JurisPage websites go live inside the 45-day full setup window alongside brand design, GBP, Yelp, Apple Maps, citations, and tracking. That includes discovery, wireframes, design, content writing, development, and launch. Custom redesigns for established firms typically take 45 to 60 days depending on content readiness and revision cycles. We build attorney review time into the timeline so publication dates don't slip." },
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="rounded-xl bg-white border border-gray-200 overflow-hidden flex flex-col">
              <div className="px-5 py-4 border-b border-gray-100">
                ...
                <div className="font-heading font-extrabold text-gray-900 text-xl">$2,500<span className="text-sm font-normal text-gray-400">/mo</span></div>
              ...
              <div className="px-5 py-4 space-y-2.5 text-sm flex-1">
                ...
                {["Brand design (logo, typography, photography, graphics, brand guidelines)", "StoryBrand-driven WordPress website", "Practice area pages with SEO content", "Google Business Profile setup", "Yelp, Apple Maps, Bing, Avvo, and 30+ directories", "Attorney-reviewed content", "Full setup live in 45 days", "No upfront fee. Costs spread over 24 months."].map((f) => (
          ...
          <p className="text-center text-sm text-gray-500 mt-8 max-w-xl mx-auto">
            Need a fully bespoke website or budget above $4,000/mo? We build custom engagements for established firms, up to $20,000/mo. <Link href="/contact/" style={{ color: O }} className="no-underline hover:underline">Contact us</Link> to scope yours.
          </p>
