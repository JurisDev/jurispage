...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "How long is the engagement?", acceptedAnswer: { "@type": "Answer", text: "JurisPage is a 24-month engagement. We front-load the work (brand design, StoryBrand website, GBP, Yelp, Apple Maps, citations, tracking) so your full marketing foundation is live in 45 days. We do not front-load the billing." } },
    ...
    { "@type": "Question", name: "How quickly can my campaign launch?", acceptedAnswer: { "@type": "Answer", text: "Full setup is completed within the first 45 days. That includes brand design, StoryBrand website, Google Business Profile, Yelp, Apple Maps, citations, and performance tracking." } },
    { "@type": "Question", name: "What's the difference between JurisPage and Juris Digital?", acceptedAnswer: { "@type": "Answer", text: "JurisPage serves law firms with budgets from $2,500 to $20,000/month: a standard package for small or startup firms, and custom engagements for established firms. Juris Digital is our full-service brand for established firms investing $20,000+/month in SEO, Google Ads, content strategy, and market domination. Same parent company, same expertise, different scale." } },
    { "@type": "Question", name: "How much does Juris Digital cost?", acceptedAnswer: { "@type": "Answer", text: "Juris Digital partnerships are fully bespoke and start at $20,000+/month. Investment is based on your firm size, practice areas, markets, and growth goals. Contact us to talk through whether it's the right fit." } },
    { "@type": "Question", name: "Do I need to be a certain size for Juris Digital?", acceptedAnswer: { "@type": "Answer", text: "Juris Digital is built for established firms with a monthly marketing budget of at least $20,000. If your budget is under that, JurisPage is designed specifically for you." } },
...
const faqs = [
  ...
  { question: "How quickly can my campaign launch?", answer: "Full setup is completed within the first 45 days. That includes brand design, StoryBrand website, Google Business Profile, Yelp, Apple Maps, citations, and performance tracking." },
  { question: "What's the difference between JurisPage and Juris Digital?", answer: "JurisPage serves law firms with budgets from $2,500 to $20,000/month: a standard package for small or startup firms, and custom engagements for established firms. [Juris Digital](https://jurisdigital.com/services/ascend/) is our full-service brand for established firms investing $20,000+/month in SEO, Google Ads, content strategy, and market domination. Same parent company, same expertise, different scale." },
  { question: "How much does Juris Digital cost?", answer: "[Juris Digital](https://jurisdigital.com/services/ascend/) partnerships are fully bespoke and start at $20,000+/month. Investment is based on your firm size, practice areas, markets, and growth goals. Contact us to talk through whether it's the right fit." },
  { question: "Do I need to be a certain size for Juris Digital?", answer: "[Juris Digital](https://jurisdigital.com/services/ascend/) is built for established firms with a monthly marketing budget of at least $20,000. If your budget is under that, JurisPage is designed specifically for you." },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 text-left flex flex-col">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-6">
                For small or startup law firms with little to no online presence. Brand design, StoryBrand website, SEO, GBP, Yelp, and Apple Maps. Transparent pricing, no upfront fee.
              </p>
              ...
              <p className="text-xs text-gray-400 mt-3 text-center">Starting at $2,500/month</p>
            </div>
            ...
            <div className="rounded-2xl p-8 text-left flex flex-col" style={{ background: "#1a1a1a" }}>
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                For established firms ready to invest $20,000+/month in full-service SEO, Google Ads, content strategy, and true market leadership.
              </p>
              ...
              <p className="text-xs text-gray-500 mt-3 text-center">Starting at $20,000+/month</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="jurispage" className="scroll-mt-20 bg-gray-50 py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            Want the full JurisPage breakdown?{" "}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="rounded-2xl p-8 text-center" style={{ background: "#1a1a1a" }}>
            ...
            <p className="text-gray-400 text-base mb-6 max-w-lg mx-auto">
              Investment starts at $20,000+/month and scales with your firm size, practice areas, competitive landscape, and growth goals.
            </p>
            <Link
              href="/contact/"
