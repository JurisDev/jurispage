...
export default function ServicePage({ service }: ServicePageProps) {
  ...
  return (
    <>
      ...
      <section className="bg-white py-16 px-6 border-b border-gray-100">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              {service.slug === "law-firm-seo" && (
                <div className="flex items-center gap-2 mb-4">
                  <div className="flex" aria-label="4.9 out of 5 stars">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <svg key={star} className="w-5 h-5" viewBox="0 0 20 20" fill="#facc15" aria-hidden="true">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                    ))}
                  </div>
                  <span className="text-sm font-semibold text-gray-900">4.9</span>
                  <span className="text-sm text-gray-500">from 27 Google Reviews</span>
                </div>
              )}
            ...
            ) : service.slug === "generative-engine-optimization-legal-marketing" ? (
              <div className="bg-gray-50 rounded-2xl p-6">
                <Suspense fallback={<div className="bg-white rounded-2xl border border-gray-100 shadow-lg p-8 text-center text-gray-500">Loading form...</div>}>
                  <AiSearchReportForm />
                </Suspense>
      ...
      {/* Red Pen Video CTA */}
      {service.slug === "law-firm-seo" && <RedPenVideo />}
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg max-w-xl mx-auto">
                Enter your domain and a competitor to get a free SEO gap analysis for your law firm.
              </p>
            </div>
            <Suspense fallback={<div className="bg-white rounded-2xl border border-gray-100 shadow-lg p-8 text-center text-gray-500">Loading form...</div>}>
              <CompetitorGapForm />
