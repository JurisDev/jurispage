...
export default function MetroPage({ metro, service }: MetroPageProps) {
  ...
  const schema = [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { "@type": "Question", name: `What does ${serviceLabel.toLowerCase()} cost for ${metro.city} law firms?`, acceptedAnswer: { "@type": "Answer", text: `Our pricing starts at $2,500/month. The right plan depends on your practice area, competitive landscape, and growth goals. We're happy to recommend the right fit after a free consultation.` } },
      ],
    },
  ];
  ...
  const serviceFaqs: Record<MetroService, { question: string; answer: string }[]> = {
    "law-firm-seo": [
      ...
      { question: `What SEO strategy works best for ${metro.city} law firms?`, answer: `It depends on your practice area and competitive landscape. ${metro.legalMarketNote} We combine [technical SEO](/blog/technical-seo-for-law-firms/), local map pack optimization, content targeting ${metro.city}-specific legal queries, and authority building from trusted legal sources. Every strategy is customized after we audit your current position.` },
    ],
    "google-ads-lawyers": [
    ...
    "law-firm-website-design": [
      { question: `How long does it take to build a law firm website for a ${metro.city} practice?`, answer: `Our standard timeline is 45 days from kickoff to full marketing launch with our JurisPage package (website, Google Business Profile, Yelp, Apple Maps, citations, and tracking all live). Every site is mobile-first, fast-loading, StoryBrand-driven, and built to convert visitors into consultation requests from day one.` },
  ...
  const faqs = [
    ...
    ...serviceFaqs[service],
    { question: `What does ${serviceLabel.toLowerCase()} cost for ${metro.city} law firms?`, answer: `Our pricing starts at $2,500/month. We'll give you a straight answer on cost during your first conversation. No runaround, no mystery packages. We'll recommend the right plan after a free consultation.` },
    { question: "How long is the engagement?", answer: "JurisPage is a 24-month engagement. We front-load the work (website, Google Business Profile, Yelp, Apple Maps, citations, content foundation, and tracking all live in 45 days) but spread the cost across the full term so you never pay a large upfront fee." },
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              { step: "4", title: "You see results, month over month", body: "No upfront fee. Costs spread across the 24-month engagement. Monthly content refreshes and ongoing local SEO keep your pipeline compounding." },
            ].map((item) => (
