...
export const services: ServiceData[] = [
  {
    ...
    faqs: [
      ...
      { question: "Do you guarantee rankings?", answer: "No. Any agency that guarantees specific Google rankings is either lying or planning to rank you for keywords nobody searches. Google weighs hundreds of factors and changes its algorithm thousands of times per year, and no one controls it. We set specific performance benchmarks and review the numbers with you. You also see every link built, every page published, and every technical fix completed, with clear attribution to results. If performance is not tracking to plan, we change the strategy and explain why." },
  ...
  },
  {
    ...
    features: [
      ...
      "Delivered in 45 days for JurisPage clients (website live alongside GBP, Yelp, and Apple Maps)",
    ],
    faqs: [
      ...
      { question: "How long does a new website take?", answer: "JurisPage websites go live within 45 days alongside the full marketing foundation (Google Business Profile, Yelp, Apple Maps, citations, and tracking)." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Can I upgrade to a higher plan later?", answer: "Yes. JurisPage is designed as a foundation. Once your firm is established and ready to invest more, we scale your engagement with added SEO, content, and paid advertising, up to $20,000/month. There's no penalty and no restart needed." },
    ],
    stats: [
      { value: "45 days", label: "Full marketing foundation live (website, GBP, citations, tracking)" },
